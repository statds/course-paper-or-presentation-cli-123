...
Institute (III) \citet{iii}, which has regularly offered thorough information on catastrophic occurrences and its consequences. We will also 
depend on Aon's 2023 Weather, Climate, and Catastrophe Insight Report \citet{aon}, which acts as a trustworthy and up-to-date reference for data 
...
performing a thorough analysis of the information obtained from the Insurance Information Institute (III) \citet{iii}and Aon's 2023 Weather, 
Climate, and Catastrophe Insight Report\citet{aon}. To comprehend the relationships between the frequency and severity of weather catastrophes 
